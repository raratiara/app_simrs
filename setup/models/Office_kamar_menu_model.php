...
class Office_kamar_menu_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "setup/office_kamar_menu";
 	protected $table_name 				= _PREFIX_TABLE."kamar";
	...
	public function add_data($post) {
		$data = [
			...
			'deskripsi' 	=> trim($post['fasilitas']),
			'tarif' 		=> trim($post['tarif']),
			'kapasitas' 	=> trim($post['kapasitas']),
			'terisi' 		=> trim($post['terisi']),
			'kosong' 		=> trim($post['kosong']),
	...
	{
		$sql = "select kelas, deskripsi, tarif, kapasitas, terisi, kosong from kamar
	   		ORDER BY id ASC
		";
