...
class Wilayah_provinsi_menu_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "setup/wilayah_provinsi_menu";
 	protected $table_name 				= _PREFIX_TABLE."provinsi";
	...
	public function getRowData($id) { 
		...
		if(!empty($rs->parent_id)){
			$ri = $this->db->select('name as parent_title')->where([$this->primary_key => $rs->parent_id])->get($this->table_name)->row();
