...
class Wilayah_kecamatan_menu_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "setup/wilayah_kecamatan_menu";
 	protected $table_name 				= _PREFIX_TABLE."kec";
	...
	public function get_list_data()
	{
		...
		$sTable = '(SELECT a.id, a.name as kecamatan, b.name as kota, c.name as provinsi
					FROM kec a left join kabkota b on b.id = a.kabkota_id
					left join provinsi c on c.id = a.provinsi_id)dt';
	...
	public function getRowData($id) { 
		$mTable = '(SELECT a.id, a.name as kecamatan, b.name as kota, c.name as provinsi, a.kabkota_id, a.provinsi_id FROM kec a left join kabkota b on b.id = a.kabkota_id left join provinsi c on c.id = a.provinsi_id)dt';
	...
	{
		$sql = "select a.id, a.name as kecamatan, b.name as kota, c.name as provinsi
				FROM kec a left join kabkota b on b.id = a.kabkota_id
				left join provinsi c on c.id = a.provinsi_id order by a.id asc
		";
