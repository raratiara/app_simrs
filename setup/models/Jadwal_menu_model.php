...
class Jadwal_menu_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "setup/jadwal_menu";
 	protected $table_name 				= _PREFIX_TABLE."jadwal_dokter";
	...
	public function get_list_data()
	{
		...
		$sTable = '(SELECT a.id, a.dokter_id, a.hari, a.jam, b.nama as dokter FROM jadwal_dokter a
					left join dokter b on b.id = a.dokter_id)dt';
	...
	public function getRowData($id) { 
		$mTable = '(SELECT a.id, a.dokter_id, a.hari, a.jam, b.nama as dokter FROM jadwal_dokter a
					left join dokter b on b.id = a.dokter_id)dt';
	...
	{
		$sql = "select a.id, b.nama as dokter, a.hari, a.jam FROM jadwal_dokter a
