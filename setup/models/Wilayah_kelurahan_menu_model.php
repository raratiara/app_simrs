...
class Wilayah_kelurahan_menu_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "setup/wilayah_kelurahan_menu";
 	protected $table_name 				= _PREFIX_TABLE."kelurahan";
	...
	public function get_list_data()
	{
		...
		$sTable = '(SELECT a.id, a.name as kelurahan, b.name as kecamatan, c.name as kota, d.name as provinsi
						FROM kelurahan a left join kec b on b.id = a.kec_id
						left join kabkota c on c.id = a.kabkota_id
						left join provinsi d on d.id = a.provinsi_id)dt';
	...
	public function getRowData($id) { 
		$mTable = '(SELECT a.id, a.name as kelurahan, b.name as kecamatan, c.name as kota, d.name as provinsi,
					a.kec_id, a.kabkota_id, a.provinsi_id
						FROM kelurahan a left join kec b on b.id = a.kec_id
						left join kabkota c on c.id = a.kabkota_id
						left join provinsi d on d.id = a.provinsi_id)dt';
	...
	{
		$sql = "select a.id, a.name as kelurahan, b.name as kecamatan, c.name as kota, d.name as provinsi
				FROM kelurahan a left join kec b on b.id = a.kec_id
				left join kabkota c on c.id = a.kabkota_id
				left join provinsi d on d.id = a.provinsi_id
				order by a.id asc
		";
