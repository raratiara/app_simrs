...
class Wilayah_kabupaten_menu_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "setup/wilayah_kabupaten_menu";
 	protected $table_name 				= _PREFIX_TABLE."kabkota";
	...
	public function get_list_data()
	{
		...
		$sTable = '(select a.id, a.name as kota, b.name as provinsi from kabkota a left join provinsi b on b.id = a.provinsi_id)dt';
	...
	public function getRowData($id) { 
		$mTable = '(select a.id, a.name as kota, b.name as provinsi, a.provinsi_id from kabkota a left join provinsi b on b.id = a.provinsi_id)dt';
	...
	{
		$sql = "select a.id, a.name as kota, b.name as provinsi from kabkota a left join provinsi b on b.id = a.provinsi_id
