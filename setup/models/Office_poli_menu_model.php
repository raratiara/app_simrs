...
class Office_poli_menu_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "setup/office_poli_menu";
 	protected $table_name 				= _PREFIX_TABLE."poli";
	...
	public function get_list_data()
	{
		...
		$sTable = '(SELECT a.id, a.lantai, a.parent_id, a.nama, b.nama as parent 
					FROM poli a 
					left join poli b on b.id = a.parent_id)dt';
	...
	public function getRowData($id) { 
		$mTable = '(SELECT a.id, a.lantai, a.parent_id, a.nama, b.nama as parent 
					FROM poli a 
					left join poli b on b.id = a.parent_id)dt';
	...
	{
		$sql = "select a.id, a.lantai, a.nama, b.nama as parent 
				FROM poli a 
				left join poli b on b.id = a.parent_id
	   		ORDER BY a.id ASC
		";
