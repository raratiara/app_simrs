        ...
        success: function(data)
        {
			if(data != false){
				if(save_method == 'update'){ 
					...
					$('select#jenis_kelamin').val(data.jenis_kelamin).trigger('change.select2');
					...
					$('select#prov').val(data.provinsi_id_tinggal).trigger('change.select2');
					$('select#kec').val(data.kec_id_tinggal).trigger('change.select2');
					$('select#kab').val(data.kabkota_id_tinggal).trigger('change.select2');
					$('select#kel').val(data.kel_id_tinggal).trigger('change.select2');
					$('select#prov_identitas').val(data.prov_id_identitas).trigger('change.select2');
					$('select#kec_iden').val(data.kec_id_identitas).trigger('change.select2');
					$('select#kab_identitas').val(data.kabkota_id_identitas).trigger('change.select2');
					$('select#kel_identitas').val(data.kel_id_identitas).trigger('change.select2');
					$.uniform.update();
					$('#mfdata').text('Update');
