        ...
        success: function(data)
        {
			if(data != false){
				if(save_method == 'update'){ 
					...
					$('span.no_tagihan').html(data.no_tagihan);
					$('span.tgl_tagihan').html(data.tgl_tagihan);
					$('span.nama').html(data.pasien);
					$('span.no_rm').html(data.no_rekam_medis);
					$('span.jenis_kelamin').html(data.jenis_kelamin);
					$('span.tgl_lahir').html(data.tgl_lahir);
					$('span.dokter').html(data.dokter);
					$('span.unit').html(data.poli);
					$('span.total_biaya').html(data.id);
					$('span.diskon').html(data.id);
					$('span.total_ygharus_dibayar').html(data.id);
