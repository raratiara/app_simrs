        ...
        success: function(data)
        {
			if(data != false){
				if(save_method == 'update'){ 
					$('[name="id"]').val(data.id);
					$('[name="pendaftaran_id"]').val(data.id_pendaftaran);
					$('span.no_tagihan').html(data.invoice_no);
					$('span.tgl_tagihan').html(data.invoice_date);
					$('span.nama').html(data.pasien);
					$('span.no_rm').html(data.no_rekam_medis);
					$('span.jenis_kelamin').html(data.jenis_kelamin_desc);
					$('span.tgl_lahir').html(data.tgl_lahir);
					$('span.dokter').html(data.dokter);
					$('span.unit').html(data.poli);
					$('span.total_biaya').html(data.ttl_biaya);
					$('span.diskon').html(data.diskon);
					$('span.total_ygharus_dibayar').html(data.ttl_biaya);
					$('span.biaya_obat').html(data.biaya_obat);
					$('span.qty_item_obat').html(data.qty_item_obat);


					$('[name="metode_pembayaran"]').val(data.metode_pembayaran);
